      ...
      <div className="w-5/6 mx-auto lg:flex h-auto">
        <div id="info" className="lg:w-[50%] bg-[#083552] md:w-[100%] p-[15px]">
          ...
          <div className="lg:m-[40px] lg:ml-[50px] md:m-[20px] pt-[30px] pt-15 md:pl-15 lg:pl-2">
            ...
            <div className="flex ">
              <Image src={whats} />
              <li className="ml-[5px] text-white list-none"><p><a href='https://wa.link/4d2ezs' className="hover:text-[#8bba1f]">Contactanos por Whatsapp</a></p></li>
            </div><br/>
            <div className="flex ">
              <Image src={correo} />
              <li className="ml-[5px] text-white list-none"><p><a href="mailto:metalc_yes@hotmail.com" className="hover:text-[#8bba1f]">Envianos un correo</a></p></li>
            </div>
          </div>
        </div>
